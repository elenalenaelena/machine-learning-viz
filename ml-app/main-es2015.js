...
/* harmony import */ var _bar_chart_bar_chart_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bar-chart/bar-chart.component */ "./src/app/bar-chart/bar-chart.component.ts");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 5, vars: 3, consts: [["role", "banner", 1, "toolbar"], ["role", "main", 1, "content"], [1, "w50-responsive", 3, "data"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _pointlist_pointlist_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pointlist/pointlist.component */ "./src/app/pointlist/pointlist.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        ...
        _pointlist_pointlist_component__WEBPACK_IMPORTED_MODULE_5__["PointlistComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _bar_chart_bar_chart_component__WEBPACK_IMPORTED_MODULE_4__["BarChartComponent"],
                    _pointlist_pointlist_component__WEBPACK_IMPORTED_MODULE_5__["PointlistComponent"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"],
                    _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"],
...
class BarChartComponent {
    ...
    createChart() {
        ...
        const svg = d3__WEBPACK_IMPORTED_MODULE_1__["select"](element).append('svg')
            .attr('width', element.offsetWidth)
            .attr('height', element.offsetHeight);
        const contentWidth = element.offsetWidth - this.margin.left - this.margin.right;
        const contentHeight = element.offsetHeight - this.margin.top - this.margin.bottom;
        const dataset = this.data;
        let nest = d3__WEBPACK_IMPORTED_MODULE_1__["nest"]()
            .key(function (d) { return d.language; })
            .sortKeys(d3__WEBPACK_IMPORTED_MODULE_1__["ascending"])
            .rollup(function (v) { return v.length; })
            .entries(dataset);
        console.log(JSON.stringify(nest));
        const xScale = d3__WEBPACK_IMPORTED_MODULE_1__["scaleOrdinal"]()
        ...
        g.append('g')
            ...
            .call(d3__WEBPACK_IMPORTED_MODULE_1__["axisLeft"](yScale).ticks(10))
            .append('text')
...
BarChartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BarChartComponent, selectors: [["app-bar-chart"]], viewQuery: function BarChartComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { data: "data" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]()], decls: 4, vars: 0, consts: [["id", "chart", 3, "resize"], ["chart", ""]], template: function BarChartComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("resize", function BarChartComponent_Template_div_resize_2_listener($event) { return ctx.onResize($event); }, false, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresolveWindow"]);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PointlistComponent", function() { return PointlistComponent; });
...
const _c0 = ["pointlist"];
function PointlistComponent_li_3_Template(rf, ctx) { if (rf & 1) {
...
class PointlistComponent {
    ...
    createPointlist() {
        ...
        const y = d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"]()
            ...
            .domain([0, d3__WEBPACK_IMPORTED_MODULE_2__["max"](data, d => d.legs)]);
        let myColor = d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"]()
            .domain([0, d3__WEBPACK_IMPORTED_MODULE_2__["max"](data, d => d.legs)])
            .range(["red", "blue"]);
        const g = svg.append('g')
            .attr('transform', 'translate(' + this.margin.left + ',' + this.margin.top + ')');
        ...
        g.append('g')
            .attr('class', 'axis axis--y')
            .call(d3__WEBPACK_IMPORTED_MODULE_2__["axisLeft"](y).ticks(5))
            .append('text')
            .attr('transform', 'rotate(-90)')
            .attr('y', 6)
            .attr('dy', '0.71em')
    ...
    train() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const xs = _tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_3__["tensor1d"]([3.2, 4.4, 5.5]);
            const ys = _tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_3__["tensor1d"]([1.6, 2.7, 3.5]);
            // Train
            yield this.linearModel.fit(xs, ys);
            console.log('model trained!');
        });
    }
    predict(val) {
        const output = this.linearModel.predict(_tensorflow_tfjs__WEBPACK_IMPORTED_MODULE_3__["tensor2d"]([val], [1, 1]));
        this.prediction = Array.from(output.dataSync())[0];
    }
}
PointlistComponent.ɵfac = function PointlistComponent_Factory(t) { return new (t || PointlistComponent)(); };
PointlistComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: PointlistComponent, selectors: [["app-pointlist"]], viewQuery: function PointlistComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { data: "data" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵNgOnChangesFeature"]()], decls: 4, vars: 1, consts: [[4, "ngFor", "ngForOf"]], template: function PointlistComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](PointlistComponent, [{
...
module.exports = __webpack_require__(/*! /home/lena/Desktop/machine-learning-viz/src/main.ts */"./src/main.ts");
